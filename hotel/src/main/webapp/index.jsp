    ...
    <body>
        ...
        <div class = "sidenav" id = "sidenav">
            ...
            <ul class = "navbar">
                ...
                <li><a href = "#rooms">vehicles</a></li>
                <li><a href="add.jsp">hotel details</a></li>
                <li><a href = "#customers">place management</a></li>
            </ul>
            ...
            <div class = "rooms-container">
                ...
                <article class = "room">
                    ...
                    <div class = "room-text">
                        ...
                        <a href="add.jsp"><button type = "button" id="btn" class = "btn">click here</button></a>
                    </div>
                </article>
